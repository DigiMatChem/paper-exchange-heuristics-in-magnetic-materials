...
if not os.path.isfile("data_and_plots/dfs_of_magnetic_edge_information_0p5_zero-magmom_threshold.json"):
    all_stats_dict = {}
    ...
    with open(f"data_and_plots/dfs_of_magnetic_edge_information_0p5_zero-magmom_threshold.json", "w") as f:

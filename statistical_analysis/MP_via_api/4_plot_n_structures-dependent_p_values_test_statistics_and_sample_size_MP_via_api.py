...
Note: bootstrap structures, not single bond angle occurrences. as the latter would not be physically meaninful.
...
plot_and_data_dir = "data"

with open(os.path.join(plot_and_data_dir, "unique_4559_cnfeat_MP_db_from_api.json")) as f:

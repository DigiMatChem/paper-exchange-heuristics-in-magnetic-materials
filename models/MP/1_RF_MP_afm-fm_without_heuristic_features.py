"""Trains AFM/FM models on MP dataset with heuristic feature groups removed.
The train set index is given via a command line argument."""
import json
import pandas as pd
...
score_type = "classic"
target_name = f"target_{score_type}"
data_filter = "MP"


elim_dict = {"wobcd": lambda f: not ("bond_angle" in f or "_perc" in f or "neighbor_distance" in f),
             "wod": lambda f: not "neighbor_distance" in f,
